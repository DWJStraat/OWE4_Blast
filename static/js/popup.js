function infoPopUp_orgname() {hide_orgname();hide_protname();hide_header();hide_seq();hide_eval_threshold();
    hide_query_coverage();hide_origin();
    var popup = document.getElementById("infopopup_orgname");
    popup.classList.toggle("show");}

function infoPopUp_protname() {hide_orgname();hide_protname();hide_header();hide_seq();hide_eval_threshold();
    hide_query_coverage();hide_origin();
    var popup = document.getElementById("infopopup_protname");
    popup.classList.toggle("show");}

function infoPopUp_header() {hide_orgname();hide_protname();hide_header();hide_seq();hide_eval_threshold();
    hide_query_coverage();hide_origin();
    var popup = document.getElementById("infopopup_header");
    popup.classList.toggle("show");}

function infoPopUp_seq() {hide_orgname();hide_protname();hide_header();hide_seq();hide_eval_threshold();
    hide_query_coverage();hide_origin();
    var popup = document.getElementById("infopopup_seq");
    popup.classList.toggle("show");}

function infoPopUp_eval_threshold() {hide_orgname();hide_protname();hide_header();hide_seq();hide_eval_threshold();
    hide_query_coverage();hide_origin();
...
function hide_query_coverage() {var popup = document.getElementById("infopopup_query_coverage");
    popup.classList.remove("show");}
function hide_origin() {var popup = document.getElementById("infopopup_origin");
    popup.classList.remove("show");}