...
class Search(FlaskForm):
    ...
    protname = StringField(Markup('<button_protname class="info-button", onclick="infoPopUp_protname()", title="info">'
                                  '<img src = "../static/image/info_FILL0_wght400_GRAD0_opsz48.png">'
                                  '<span class="popuptext" id="infopopup_protname">test text</span>')
                           , render_kw={"placeholder": "Name of protein"})
    header = StringField(Markup('<button_header class="info-button", onclick="infoPopUp_header()", title="info">'
                                '<img src = "../static/image/info_FILL0_wght400_GRAD0_opsz48.png">'
                                '<span class="popuptext" id="infopopup_header">test text</span>')
                         , render_kw={"placeholder": "Header of sequence"})
    seq = StringField(Markup('<button_seq class="info-button", onclick="infoPopUp_seq()", title="info">'
                             '<img src = "../static/image/info_FILL0_wght400_GRAD0_opsz48.png">'
                             '<span class="popuptext" id="infopopup_seq">test text</span>')
                      , render_kw={"placeholder": "Sequence"})
    eval_threshold = StringField(Markup('<button_eval_threshold class="info-button", '
                                        'onclick="infoPopUp_eval_threshold()", title="info">'
                                        '<img src = "../static/image/info_FILL0_wght400_GRAD0_opsz48.png">'
                                        '<span class="popuptext" id="infopopup_eval_threshold">test text</span>')
                                 , render_kw={"placeholder": "E-value threshold"})
    query_coverage = StringField(Markup('<button_query_coverage class="info-button", '
                                        'onclick="infoPopUp_query_coverage()", title="info">'
                                        '<img src = "../static/image/info_FILL0_wght400_GRAD0_opsz48.png">'
                                        '<span class="popuptext" id="infopopup_query_coverage">test text</span>')
                                 , render_kw={"placeholder": "Query coverage"})
    origin = StringField(Markup('<button_origin class="info-button", onclick="infoPopUp_origin()", title="info">'
                                '<img src = "../static/image/info_FILL0_wght400_GRAD0_opsz48.png">'
